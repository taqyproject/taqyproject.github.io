...
<input type=text id=first_name name=first_name class="feedback-input" placeholder="Nama Kakak" required>
<input type=text id=mobile name=mobile class="feedback-input" placeholder="Nomor WhatsApp" required>
